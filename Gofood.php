...
echo color("red","| github: Pencari kenikmatan |\n");
echo color("red","| fanspage : pencari kenikmatan|\n");
echo color("red","| Creator : Pencari kenikmatan.com          |\n");
echo "| Version : Pertamax X Dexlite     |\n";
