...
echo color("red","| github      : Mau Kaya |\n");
echo color("red","| fanspage :Auto Tajir|\n");
...
// function change(){
        ...
        sleep(3);
        $022620A = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOFOOD022620A"}');
        ...
        sleep(3);
        $022620A = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOFOOD022620A"}');
        $message022620A = fetch_value($GOFOOD022620A,'"message":"','"');
        if(strpos($022620A, 'Promo kamu sudah bisa dipakai.')){
        echo "\n".color("green","+] Message: ".$message022620A);
        goto goride;
        }else{
